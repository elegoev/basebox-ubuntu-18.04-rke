...
The base image is provisioned with bash script [ubuntu-18.04-rke.sh](https://github.com/elegoev/vagrant-ubuntu1804-rke/blob/master/provisioning/ubuntu-18.04-rke.sh)
